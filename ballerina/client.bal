...
public isolated client class Client {
    ...
    isolated remote function execute(string functionName, record {|FieldType?...;|} importParams, typedesc<xml|json> exportParams = <>) returns exportParams|Error = @java:Method {
